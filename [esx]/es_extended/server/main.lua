...
local posList = {}
posList[1] = {x = -269.4, y = -955.3, z = 31.2, heading = 205.8}
posList[2] = {x = -802.311, y = 175.056, z = 72.8446, heading = 205.8}
posList[3] = {x = -9.96562, y = -1438.54, z = 31.1015, heading = 205.8}
posList[4] = {x = 0.916756, y = 528.485, z = 174.628, heading = 205.8}
posList[5] = {x = 1975.86, y = 3821.03, z = 33.4501, heading = 205.8}
posList[6] = {x = 657.723, y = 457.342, z = 144.641, heading = 205.8}
posList[7] = {x= 1391.773, y = 3608.716, z = 38.942, heading = 205.8}
posList[8] = {x = 150.126, y = -754.591, z = 262.865, heading = 205.8}
...
-- 			
	...
	Async.parallel(tasks, function(results)
		...
		--TriggerEvent("teleport", xPlayer1.coords)
...
ESX.RegisterUsableItem(
    "namechanger",
    function(source)
        TriggerClientEvent("es_extended:changename", source)
...
ESX.RegisterUsableItem(
    "initializer",
    function(source)
        TriggerClientEvent('cui_character:open', source, { 'identity', 'features', 'style', 'apparel' }, false)
		xPlayer.removeInventoryItem('initializer', 1)
    end
)

RegisterServerEvent("es_extended:changefirstname")
AddEventHandler("es_extended:changefirstname", function(firstname)
	local xPlayer = ESX.GetPlayerFromId(source)
	MySQL.Async.execute('UPDATE users SET firstname = @firstname WHERE identifier = @identifier', {
		['@firstname'] = firstname,
		['@identifier'] = xPlayer.identifier
	})
	xPlayer.removeInventoryItem('namechanger', 1)
end)

RegisterServerEvent("es_extended:changelastname")
AddEventHandler("es_extended:changelastname", function(lastname)
	local xPlayer = ESX.GetPlayerFromId(source)
