...
Citizen.CreateThread(function()
	...
	ESX.TriggerServerCallback('esx_scoreboard:getConnectedPlayers', function(connectedPlayers)
		print(json.encode(connectedPlayers))
...
RegisterNetEvent("esx_scoreboard:refresh")
AddEventHandler("esx_scoreboard:refresh",function()
	ESX.TriggerServerCallback('esx_scoreboard:getConnectedPlayers', function(connectedPlayers)
		UpdatePlayerTable(connectedPlayers)
	end)
end)
...
Citizen.CreateThread(function()
	...
	while true do
		...
		SendNUIMessage({
			action = 'updateServerInfo',
			playTime = string.format("%02d 시간 %02d 분", playHour, playMinute)
		})
	end
end)
