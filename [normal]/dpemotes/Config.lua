...
Config.Languages = {
  ['en'] = {
        ...
        ['propemotes'] = "📦 물건 이모트",
        ['favoriteemotes'] = "🌟 즐겨찾기",
        ['favoriteinfo'] = "즐겨찾기에 등록할 이모트를 선택하세요.",
        ['rfavorite'] = "즐겨찾기 재설정",
        ['prop2info'] = "❓ 물건 이모트는 끝에 있습니다.",
        ['set'] = "Set (",
        ['setboundemote'] = ") 등록된 이모트입니다.",
        ['newsetemote'] = "~w~ 이제 ~g~CapsLock~w~ 를 눌러 사용할 수 있습니다.",
        ['cancelemote'] = "이모트 취소",
        ['cancelemoteinfo'] = "~r~X~w~ 현재 행동하는 이모트를 취소 합니다.",
        ['walkingstyles'] = "걷기 스타일",
        ['resetdef'] = "기본값으로 재설정합니다.",
        ['normalreset'] = "기본 (재설정)",
        ['moods'] = "표정",
        ['infoupdate'] = "정보",
        ['infoupdateav'] = "정보 (업데이트)",
        ['infoupdateavtext'] = "업데이트를 사용할 수 있습니다. 최신버전은 ~y~https://github.com/andristum/dpemotes~w~ 에서 확인하세요.",
        ['suggestions'] = "제안하기",
        ['suggestionsinfo'] = "'dullpear_dev' on FiveM forums for any feature/emote suggestions! ✉️",
        ['notvaliddance'] = "유효한 춤이 아닙니다.",
        ['notvalidemote'] = "유효한 이모트가 아닙니다.",
        ['nocancel'] = "취소할 이모트가 행동 중이지 않습니다.",
        ['maleonly'] = "해당 이모트는 남성 전용입니다!",
        ['emotemenucmd'] = "이모트 메뉴 명령어는 /emotemenu 입니다.",
        ['shareemotes'] = "👫 단체 이모트",
        ['shareemotesinfo'] = "근처 플레이어를 이모트에 초대합니다.",
        ['sharedanceemotes'] = "🕺 단체 춤",
        ['notvalidsharedemote'] = "유효한 단체 이모트가 아닙니다.",
        ['sentrequestto'] = "~y~에 요청을 보냈습니다.",
        ['nobodyclose'] = "근처에 플레이어가 없습니다.",
        ['doyouwanna'] = "~y~Y~w~ 요청을 수락했습니다, ~r~L~w~ 요청을 거절했습니다 (~g~",
        ['refuseemote'] = "이모트를 거절했습니다.",
        ['makenearby'] = "근처 플레이어 이모트를 하게 합니다.",
        ['camera'] = "카메라 플래시를 사용하려면 ~y~G~w~ 를 누르세요.",
        ['makeitrain'] = "비가 오도록 ~y~G~w~ 를 누릅니다.",
        ['pee'] = "~y~G~w~ 키를 눌러 소변을 봅니다.",
        ['spraychamp'] = "샴페인을 뿌리기 위해 ~y~G~w~ 키를 누르세요.",
        ['bound'] = "바운드",
        ['to'] = "to",
        ['currentlyboundemotes'] = "현재 설정된 이모트:",
        ['notvalidkey'] = "유효한 키가 아닙니다.",
        ['keybinds'] = "🔢 키바인드",
        ['keybindsinfo'] = "사용하기"
  },
  ['fr'] = {
