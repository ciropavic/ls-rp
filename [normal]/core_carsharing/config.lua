Config = {
	...
	badParkingDelete = true, -- Delete the vehicle if left outside zone
	...
	vehicleSpawnRate = 30, -- Seconds to wait in zone until vehicle spawns

	vehicleUnlockFee = 200.0, -- The price paid to unlock a vehicle
	vehicleUnlockKey = 'G',    -- The key used to unlock vehicle

	licenseRequired = "drive", -- Keep empty if license is not required or us registered license on ESX

	--Blip information https://docs.fivem.net/docs/game-references/blips/
	ZoneBlipDisplay = 326,
	ZoneBlipColor = 3, 
	ZoneBlipText = "[일반] 카 쉐어링 지역",
	...
	Vehicles = {
		...
		{
			Display = "Issi", -- Display name of vehicle (Ex. BMW X5 2019)
			Model   = "issi2", -- Model name of the car used to spawn vehicle
		...
		{
			Display = "Baller", -- Display name of vehicle (Ex. BMW X5 2019)
			Model   = "baller2", -- Model name of the car used to spawn vehicle
			Price   = 30.0,      -- Price per minute
		},
		{
			Display = "panto", -- Display name of vehicle (Ex. BMW X5 2019)
			Model   = "panto", -- Model name of the car used to spawn vehicle
			Price   = 10.0,      -- Price per minute
		}
	...
	Text = {
		...
		['serviceName']  = "카 쉐어링",
		['vehicleUnlocked'] = "차량 잠금이 해제되었습니다! 안전하게 운전하세요.",
		['noMoneyOrLicense'] = "돈이 충분하지 않거나, 면허가 없습니다.!",
		['paid'] = "당신은 {price}$ 지불했습니다!",
		['badParking'] = "구역 외부 주차로 인해 차량이 제거되었습니다.",
		['penaltyPaid'] = "외부 영역에 주차하는 대가로 {penaltyPrice}$ 를 지불했습니다.",
		['damagePenalty'] = "차량 손상에 대해 {penaltyPrice}$ 를 지불했습니다.",
		['pricePerMinute'] = "1 분 | ${price}",
		['vehicleInfo'] = "차량: {info}",
		['unlockText'] = "잠금을 해제하려면 ${price} 에 [ G ] 키를 누르십시오. ",
		['zoneInfo'] = "카 쉐어링 지역에서 잠깐 대기하시면 차량이 나타납니다!",
		['zoneTitle'] = "카 쉐어링 지역"
