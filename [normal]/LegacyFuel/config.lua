...
Config.Strings = {
	ExitVehicle = "주유하기 위해 차량에서 내리세요.",
	EToRefuel = "~g~E ~w~키를 눌러 주유하세요.",
	JerryCanEmpty = "석유통이 비어있습니다.",
	FullTank = "연료탱크가 가득찼습니다.",
	PurchaseJerryCan = "~g~E ~w~키를 눌러 석유통을 구매하세요. ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "~g~E ~w~키를 눌러 주유를 취소하세요.",
	CancelFuelingJerryCan = "~g~E ~w~키를 눌러 주유를 취소하세요.",
	NotEnoughCash = "현금이 충분하지 않습니다.",
	RefillJerryCan = "~g~E ~w~ 키를 눌러 석유통을 리필하세요. ",
	NotEnoughCashJerryCan = "석유통을 리필하기에 현금이 충분하지 않습니다.",
	JerryCanFull = "석유통이 가득 찼습니다.",
	TotalCost = "비용",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "~g~E ~w~를 눌러 석유통을 드세요."
	Config.Strings.RefillJerryCan = "~g~E ~w~ 를 눌러 석유를 리필하세요."
end
