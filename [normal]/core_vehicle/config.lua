...
Text = {
    ...
    ['hood_closed'] = '후드가 닫혔습니다!',
    ['mechanic_action_complete'] = '정비가 완료되었습니다.',
    ['mechanic_action_incomplete'] = '정비를 실패하였습니다.',
    ['mechanic_action_started'] = '정비가 시작되었습니다.',
    ['wrong_job'] = '잘못된 작업입니다.',
    ['not_enough'] = '아이템이 충분하지 않습니다.'
