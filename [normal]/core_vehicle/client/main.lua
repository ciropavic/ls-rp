                ...
                if repairPartType == "engine" then
                    if GetVehicleDoorAngleRatio(currentVehicle, 4) ~= 0 then
                        ...
                        if IsControlJustReleased(0, Keys["E"]) and #(pedCoords - coords) < 2.0 then
                            ESX.TriggerServerCallback("core_vehicle:returnLevel",function(level)
                                repairing = true
                                ...
                                Citizen.CreateThread(
                                    function()
                                        ...
                                        if level == 0 then
                                            if randomnum == 1 and 2 and 3 and 4 and 5 then
                                                repairsuccess = true
                                            end
                                        elseif level ==  1 then
                                            if randomnum == 1 and 2 and 3 and 4 and 5 and 6 then
                                                repairsuccess = true
                                            end
                                        elseif level ==  2 then
                                            if randomnum == 1 and 2 and 3 and 4 and 5 and 6 and 7 then
                                                repairsuccess = true
                                            end
                                        elseif level ==  3 then
                                            if randomnum == 1 and 2 and 3 and 4 and 5 and 6 and 7 and 8then
                                                repairsuccess = true
                                            end
                                        elseif level ==  4 then 
                                            if randomnum == 1 and 2 and 3 and 4 and 5 and 6 and 7 and 8 and 9 then
                                                repairsuccess = true
                                            end
                                        elseif level ==  5 then
                                            if randomnum == 1 and 2 and 3 and 4 and 5 and 6 and 7 and 8 and 9 and 10 then
                                                repairsuccess = true
                                            end
                                        end
                                        
                                        if repairsuccess == true then
                                            if repairInstall then
                                            ...
                                            TriggerServerEvent("core_vehicle:exp")
                                        else
                                            SendTextMessage(Config.Text["mechanic_action_incomplete"])
                                        end
                                    end
                                )
                            end)
...
-- 	for _, info in pairs(Config.MechanicWorkshop) do
